...
LOW_NOISE = NoiseConfig(linear_noise=0.001, angular_noise=0.0001)
MEDIUM_NOISE = NoiseConfig(linear_noise=0.1, angular_noise=0.2)
HIGH_NOISE = NoiseConfig(linear_noise=0.2, angular_noise=0.4)
